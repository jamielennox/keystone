...
class TicketController(rest.RestController):
    ...
    def post(self, ticket_request):
        ...
        # create a new base key. With the combination of this base key and the
        # information available in the metadata a client can re-generate the
        # keys required for this session.
        ...
        enc_key, sig = pecan.request.crypto.generate_keys(rndkey,
                                                          ticket_request.info)
        ...
        return ticket_request.new_response(enc_key, sig, esek)
