    ...
    def wrap(f):
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                raise exception.MalformedRequest("Invalid %s" % msg)
...
class BaseRequest(wsme.types.Base):
    ...
    def verify(self):
        ...
        try:
            ...
            raise exception.Unexpected("Couldn't reproduce signature")

        if sigc != self.signature:
            raise exception.MalformedRequest('Invalid Signature')
